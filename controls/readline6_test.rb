...
plan_name = input('plan_name', value: 'readline6')
...
control 'core-plans-readline' do
  ...
  the correct location and also that ldd works and shows ncurses is linked.
    ...
    $ ls -al /hab/pkgs/core/readline6/6.3.8/20200305232850/lib/libreadline.so
    lrwxrwxrwx 1 root root 16 Mar  5 23:29 /hab/pkgs/core/readline6/6.3.8.0/20200305232850/lib/libreadline.so -> libreadline.so.8
